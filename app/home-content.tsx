  ...
  return (
    <section className="px-4 py-20 sm:px-6 lg:py-28">
      <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[0.82fr_1.18fr] lg:items-stretch">
        ...
        <MoreLink href="/cena">Ako z auditu vyjde rozsah a cena</MoreLink>
      </div>
    </section>
  );
}
  ...
  return (
    <section id="prechod" className="px-4 py-20 sm:px-6 lg:py-28">
      <div className="mx-auto max-w-7xl">
        ...
        <MoreLink href="/migracia">Celý postup prechodu z iného systému</MoreLink>
      </div>
    </section>
  );
}
  ...
  return (
    <section className="px-4 py-20 sm:px-6 lg:py-28">
      <div className="mx-auto max-w-7xl">
        ...
        <MoreLink href="/produkt">Pozrieť všetky obrazovky admin panelu a appky</MoreLink>
      </div>
    </section>
  );
}
  ...
  return (
    <section id="otazky" className="bg-surface px-4 py-20 sm:px-6 lg:py-28">
      <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[0.82fr_1.18fr] lg:items-stretch">
        ...
        <MoreLink href="/bezobsluzne-fitko">Ako to funguje v bezobslužnom a nonstop fitku</MoreLink>
      </div>
    </section>
  );
}
...
function MoreLink({ href, children }: { href: string; children: ReactNode }) {
  return (
    <div className="mt-14 border-t border-white/10 pt-8">
      <Link
        href={href}
        className="group inline-flex items-center gap-2 text-sm font-bold text-accent-soft transition hover:text-white"
      >
        {children}
        <ArrowRight
          aria-hidden="true"
